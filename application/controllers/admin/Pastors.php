...
class Pastors extends CI_Controller
{
    ...
    public function index()
    {
        if(logged_in()) {
            ...
            $this->twig->display('admin/pastors.html', $view_data);
        } else {
    ...
    public function pastors() 
    {
        ...
        try {
            // GET request
            $response = $client->get('pastors', $options);
    ...
    public function pastor() 
    {
        ...
        try {
            // GET request
            $response = $client->get('pastors/pastors', $options);
    ...
    public function create() 
    {
        ...
        if ($this->form_validation->run()) {
            ...
            try {
                // POST request
                $response = $client->post('pastors/create', $options);  
    ...
    public function update() 
    {
        ...
        if ($this->form_validation->run()) {
            ...
            try {
                ...
                // PUT request
                $response = $client->put('pastors/update/id/' . $id, $options);
    ...
    public function delete() 
    {
        ...
        try {
            ...
            // PUT request
            $response = $client->put('pastors/soft_delete/id/' . $id, $options);
